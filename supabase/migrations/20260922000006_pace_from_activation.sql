-- ============================================================================
-- Pace starts at activation, not at the start of the week.
--
-- Someone approved on a Tuesday wasn't in the program on Monday, so Monday
-- shouldn't count as a day they owe. The pace window now opens on the later
-- of the week start and their local activation date. (finalize_week already
-- exempts partial first weeks from punishments; this makes the live colors
-- agree.)
-- ============================================================================
