...
export const PROFILE_COLUMNS = 'id,username,display_name,role,status,timezone,activated_at,created_at,sex,cohort_id,cumulative_cycle_points,rank_level,onboarded_at,mentor_participates,is_super_admin,is_mentor';
