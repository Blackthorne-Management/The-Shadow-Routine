...
// Five required goals (scored) + one optional tracking goal (0 pts, never scored)
export const CATEGORY_ORDER: Category[] = ['gym', 'refraining', 'custom_1', 'custom_2', 'custom_3', 'custom_4'];
export const SCORED_CATEGORIES: Category[] = ['gym', 'refraining', 'custom_1', 'custom_2', 'custom_3'];
export const isTracking = (g: { category: Category }) => g.category === 'custom_4';
/** Enough to check in: the five required goals */
export const hasRequiredGoals = (goals: { category: Category }[]) =>
  SCORED_CATEGORIES.every((c) => goals.some((g) => g.category === c));

export const CATEGORY_POINTS: Record<Category, number> = {
  gym: 300, refraining: 200, custom_1: 200, custom_2: 150, custom_3: 150, custom_4: 0,
};

export const CATEGORY_NAMES: Record<Category, string> = {
  gym: 'Workouts', refraining: 'Refrain', custom_1: 'Reading', custom_2: 'Eating', custom_3: 'Custom', custom_4: 'Tracking',
};
...
/** Suggested starting points for the custom slots (Reading and Eating have their own). */
