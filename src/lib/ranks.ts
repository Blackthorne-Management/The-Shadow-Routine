...
export const LEVELS: { level: number; threshold: number; male: string; female: string }[] = [
  ...
  { level: 3, threshold: 1350, male: 'Shadow Ronin', female: 'Shadow Huntress' },
  { level: 4, threshold: 2350, male: 'Shadow Blade', female: 'Shadow Oracle' },
  { level: 5, threshold: 3475, male: 'Shadow Berserker', female: 'Shadow Valkyrie' },
  { level: 6, threshold: 4710, male: 'Shadow Marshal', female: 'Shadow Matriarch' },
  { level: 7, threshold: 6035, male: 'Shadow Warlord', female: 'Shadow Empress' },
